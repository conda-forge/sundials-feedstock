...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/sundials-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/sundials-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add sundials sundials-devel sundials-static
# for installing globally
pixi global install sundials sundials-devel sundials-static
```
...
It is possible to list all of the versions of `sundials` available on your platform:
...
```
pixi search sundials --channel conda-forge
```
